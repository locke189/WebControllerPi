...
class  Camera(object):
    ...
    def __init__(self):
        ...
        path = os.getcwd()
        self.fs_string = ('sudo fswebcam -r 640x480 -S 15 --flip h --jpeg 95 --shadow --title "@Juan_Insuasti" --subtitle "Home" --info "Monitor: Active @ 1 fpm" --save -q' + path + '/static/home.jpg')
